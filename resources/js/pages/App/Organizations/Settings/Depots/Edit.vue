...
watch(location, (value) => {
    ...
    // Only update if this is a new selection from the address search
    if (value) {
    ...
    <AppLayout>
        <OrganisationLayout>
            <section class="space-y-6">
                ...
                <div class="max-w-2xl">
                    <form @submit.prevent="updateDepot" class="space-y-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-4">
                                <div class="grid gap-2">
                                    <Label for="location">Modifier l'adresse</Label>
                                    <p class="text-sm text-muted-foreground">
                                ...
                                <!-- Hidden inputs for latitude/longitude errors -->
